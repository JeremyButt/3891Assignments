...
public:
	...
	int studentsRegistered() const;

	unsigned int Number() const;

	Level level() const;

	//Creates a class list containing the names of all registered students.
...
private:
	...
	Level courseLevel;
	int courseCapacity;
	unsigned int numStudentsRegistered;
	unsigned int courseEnrolement;
	unsigned int courseSeatsRemaining;
	std::vector<std::string> classList_; // Keeps vector of names of students registered for the course.
	std::vector<Student> studentList_; // keeps vector of student objects registered for the course
