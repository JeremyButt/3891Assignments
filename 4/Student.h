...
//
// This is a "forward declaration" of the Course class. It lets us declare
// values of type reference-to-Course without having to #include "Course.h"
// (since that header file includes this one; we don't want a cycle).
//
class Course;
